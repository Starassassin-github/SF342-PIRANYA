...
import { WebhookDispatchCollectionClient } from 'apify-client/src/resource_clients/webhook_dispatch_collection';
import { ApiClientSubResourceOptions } from 'apify-client/src/base/api_client';
import { WebhookDispatch } from 'apify-client/src/resource_clients/webhook_dispatch';
/**
 * @hideconstructor
 */
...
export type WebhookUpdateData = Partial<Pick<Webhook, 'isAdHoc' | 'eventTypes' | 'condition' | 'ignoreSslErrors' | 'doNotRetry' | 'requestUrl' | 'payloadTemplate'>> & WebhookIdempotencyKey;
